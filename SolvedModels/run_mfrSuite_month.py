...
start = time.time()
Model.computeShockElas(pcts = {'W':[.5], 'Z': [0.5], 'V': [0.25, 0.5, 0.75]}, T = 576, dt = 1/12, perturb = 'Ce')
...
Model.computeShockElas(pcts = {'W':[.5], 'Z': [0.5], 'V': [0.25, 0.5, 0.75]}, T = 576, dt = 1/12, perturb = 'Ch')
