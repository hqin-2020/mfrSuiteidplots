...
python3 /project/lhansen/mfrSuiteidplots/SolvedModels/plotorg101010yearmgw200.py --chiUnderline ${chiUnderline} --a_e ${a_e} --a_h ${a_h} --gamma_e ${gamma_e} --gamma_h ${gamma_h} --psi_e ${psi_e} --psi_h ${psi_h} \
