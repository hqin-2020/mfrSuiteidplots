...
params['preLoad']          = folder_name +'_mgw200'
folder_name = folder_name + '_nb111month_mgw200'
...
Model.computeShockElas(pcts = {'W':[.5], 'Z': [0.5], 'V': [0.1, 0.25, 0.5, 0.75, 0.9]}, T = 48*12, dt = 1/12, perturb = 'Ce', bc = bc)
...
Model.computeShockElas(pcts = {'W':[.5], 'Z': [0.5], 'V': [0.1, 0.25, 0.5, 0.75, 0.9]}, T = 48*12, dt = 1/12, perturb = 'Ch', bc = bc)
