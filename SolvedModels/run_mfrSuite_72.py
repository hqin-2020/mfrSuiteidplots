...
# %%
start = time.time()
Model.computeShockElas(pcts = {'W':[.5], 'Z': [0.5], 'V': [0.25, 0.5, 0.75]}, T = 48*72, dt = 1/72, perturb = 'Ce', bc = {'natural': True})
...
Model.computeShockElas(pcts = {'W':[.5], 'Z': [0.5], 'V': [0.25, 0.5, 0.75]}, T = 48*72, dt = 1/72, perturb = 'Ch', bc = {'natural': True})
