...
# %%
start = time.time()
Model.computeShockElas(pcts = {'W':[.5], 'Z': [0.5], 'V': [0.25, 0.5, 0.75]}, T = 48*90, dt = 1/90, perturb = 'Ce', bc = {'natural': True})
...
Model.computeShockElas(pcts = {'W':[.5], 'Z': [0.5], 'V': [0.25, 0.5, 0.75]}, T = 48*90, dt = 1/90, perturb = 'Ch', bc = {'natural': True})
