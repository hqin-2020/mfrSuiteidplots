...
fig.tight_layout()
fig.savefig(plotdir + '/expoElasExperts_C_type1orghalfmonth.png')
plt.close()
...
fig.tight_layout()
fig.savefig(plotdir + '/expoElasHouseholdss_C_type1orghalfmonth.png')
plt.close()
...
fig.tight_layout()
fig.savefig(plotdir + '/priceElasExperts_C_type1orghalfmonth.png')
plt.close()
...
fig.tight_layout()
fig.savefig(plotdir + '/priceElasHouseholds_C_type1orghalfmonth.png')
plt.close()
