...
folder_name = 'chiUnderline_' + chiUnderline + '_a_e_' + a_e + '_a_h_' + a_h  + '_gamma_e_' + gamma_e + '_gamma_h_' + gamma_h + '_psi_e_' + psi_e + '_psi_h_' + psi_h + '_52'
...
fig.tight_layout()
fig.savefig(plotdir + '/expoElasExperts_C_type1orgweek.png')
plt.close()
...
fig.tight_layout()
fig.savefig(plotdir + '/expoElasHouseholdss_C_type1orgweek.png')
plt.close()
...
fig.tight_layout()
fig.savefig(plotdir + '/priceElasExperts_C_type1orgweek.png')
plt.close()
...
fig.tight_layout()
fig.savefig(plotdir + '/priceElasHouseholds_C_type1orgweek.png')
plt.close()
