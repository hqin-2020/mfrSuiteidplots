...
# %%
start = time.time()
Model.computeShockElas(pcts = {'W':[.5], 'Z': [0.5], 'V': [0.25, 0.5, 0.75]}, T = 48*24, dt = 1/24, perturb = 'Ce', bc = {'natural': True})
...
Model.computeShockElas(pcts = {'W':[.5], 'Z': [0.5], 'V': [0.25, 0.5, 0.75]}, T = 48*24, dt = 1/24, perturb = 'Ch', bc = {'natural': True})
