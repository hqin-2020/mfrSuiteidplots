...
folder_name = 'chiUnderline_' + chiUnderline + '_a_e_' + a_e + '_a_h_' + a_h  + '_gamma_e_' + gamma_e + '_gamma_h_' + gamma_h + '_psi_e_' + psi_e + '_psi_h_' + psi_h +'_mgw200_month'
...
with open(os.getcwd()+"/" + folder_name + "/Ela_expo_expert_time_info.json", "w") as f:
